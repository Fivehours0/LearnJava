...
import reuse.ConnectElasticsearch;
import reuse.ElasticsearchTask;
...
public class QueryDoc {
    ...
    public static final ElasticsearchTask SEARCH_BY_CONDITION = client -> {
        ...
        request.indices("library");
        // 构建查询的请求体
        SearchSourceBuilder sourceBuilder = new SearchSourceBuilder();
        sourceBuilder.query(QueryBuilders.matchQuery("name", "大雪"));
        ...
        for (SearchHit hit : hits) {
            ...
            Book productJson = objectMapper.readValue(hit.getSourceAsString(), Book.class);
     ...
     * 全量查询，即查询出所有数据
     */
    public static final ElasticsearchTask ALL_SEARCH = client -> {
        // 创建搜索请求对象
        SearchRequest request = new SearchRequest();
        request.indices("library");
        // 构建查询的请求体
    ...
    public static void main(String[] args) {
        ConnectElasticsearch.connect(ALL_SEARCH);
